...
EMAIL_VERIFICATION_CLEANUP_RETENTION_DAYS=7
EMAIL_VERIFICATION_CLEANUP_CRON=0 20 3 * * *
TOSS_PAYMENTS_SECRET_KEY=<staging-toss-test-secret>
TOSS_PAYMENTS_CLIENT_KEY=<staging-toss-test-client-key>
